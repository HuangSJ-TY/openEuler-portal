...
**e) Contributor License Agreement ("CLA") Signing**. When you participate in code contribution through the Contributor License Agreement ("CLA") signing system (click [here](https://clasign.osinfra.cn/sign/6946817fe1b3f3e542b4e2d9?lang=en) to learn more), you need to submit your [relevant personal data](https://clasign.osinfra.cn/privacy/corp/6946817fe1b3f3e542b4e2d9?lang=en) to the CLA signing system. We will obtain such personal data to confirm if you have signed the CLA, and to conduct statistical analysis for community operation insights.
